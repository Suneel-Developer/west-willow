                ...
                <div className='mb-3 md:px-2 flex items-center'>
                    <div className='md:max-w-[680px] md:pr-10 w-full'>
                        ...
                        <p className='text-[#212529] text-base karla-r mb-7'>
                            West & Willow is a proud sponsor of <strong className='karla-b'>Best Friends Animal Society</strong>, one of the worlds largest pet rescue & research organizations. Your purchase helps us make monthly donations to this deserving community.
                        </p>
